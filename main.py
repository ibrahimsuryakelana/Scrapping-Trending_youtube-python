...
# print(db)
scrap_db = pymysql.connect(host='127.0.0.1',user='root',password='',port=3306,db='scraping_youtube',charset = "utf8")
...
def api_request(page_token, country_code):
    request_url = f"https://www.googleapis.com/youtube/v3/videos?part=id,statistics,snippet{page_token}chart=mostPopular&regionCode={country_code}&maxResults=50&key=AIzaSyCHP4Nye7colEau9ZHZpapIEMJg60YWwQ0"
